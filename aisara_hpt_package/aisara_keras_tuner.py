...
class HpOptimization:
    ...
    def opti_objective_check(self):
        if self.opti_object_main == 'min' or self.opti_object_main == 'max':
            ...
            raise UnknownAttribute(f'''unknown unknown optimization objective for the main parameter: {self.opti_object_main}
                            optimization objective should be either "min" or "max"''')
        if self.opti_object_sup == 'min' or self.opti_object_sup == 'max':
            pass
        else:
            raise UnknownAttribute(f'''unknown unknown optimization objective for the supporting parameter: {self.opti_object_sup}
                            optimization objective should be either "min" or "max"''')
    ...
    def set_aisara_seed(self):
        if self.aisara_seed == 'fixed':
            ...
            raise UnknownAttribute('unknown aisara_seed!!... aisara_seed should be either "fixed" or "variable"')
